...
Washington: Pacific Northwest conifers have very long growth horizons and high asymptotic biomass. Under the calibrated Tier 2 per-species vector (iter1_cand11, per-plot LL = −0.217 over n = 805 paired plots), the year-100 asymptote is approximately 1.4× the year-0 biomass, indicating these stands are already near their projected asymptote — a substantially lower long-horizon ceiling than the literature Tier 0 baseline projects (~3× year-0 biomass over the century, 67% higher than Tier 2). The PERSEUS-harvest scenario therefore reduces total ecosystem carbon for most of the century under the calibrated parameters, with the HWP pool only beginning to compensate after year-70.
